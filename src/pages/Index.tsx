        ...
        <div className="max-w-4xl mx-auto px-6 relative z-20">
          ...
          <div className="space-y-8 text-lg">
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground">Routing and intersection control are usually handled as separate problems. Here we tie them together: an upper layer decides which route connected vehicles should take across the network, and a lower layer sets the traffic light phases and vehicle trajectories once they reach an intersection. We tested it in SUMO on the Sioux Falls network, and running both layers together does considerably better than either one on its own.</p>
            </div>
            <div>
              ...
              <p className="mt-2 text-muted-foreground">A more theoretical one. For energy-optimal control of a double integrator with speed and control limits, the optimal trajectory is a sequence of bang, unconstrained and coast arcs, and the difficulty is knowing where the switches fall. We work out closed-form expressions for the switching times in every admissible case, so they follow from algebra rather than a numerical search.</p>
            </div>
          </div>
        </div>
      </section>
